...
import { transformSubmitValues } from "@/app/components/Announcement/_components/announcements/createAnnouncements/rules/fieldRulesEngine"
...
interface useHandlersCreateAnnouncementProps {
  ...
  setShippingOptions: React.Dispatch<
...
export const useHandlersCreateAnnouncement = ({
  ...
  async function handleCreateAnnouncement() {
    ...
    try {
      ...
      const finalConfig = transformSubmitValues(configValues, announcementConditionalRules)
